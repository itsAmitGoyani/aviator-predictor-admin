...
// /// are type-safe.
// final seqsRef = FirebaseFirestore.instance
//     .collection('lucky-jet')
//     .withConverter<Sequence>(
//   fromFirestore: (snapshots, _) => Sequence.fromJson(snapshots.data()!),
...
// }
//
// extension on Query<Sequence> {
//   /// Create a firebase query from a [MovieQuery]
//   Query<Sequence> queryBy(MovieQuery query) {
//     switch (query) {
...
//         ],
//       ),
//       body: StreamBuilder<QuerySnapshot<Sequence>>(
//         stream: seqsRef.queryBy(query).snapshots(),
...
//     final movies = await seqsRef.get();
...
//
//   final Sequence movie;
//   final DocumentReference<Sequence> reference;
//
...
//         DocumentSnapshot<Sequence> movie =
//         await transaction.get<Sequence>(widget.reference);
//
//         if (!movie.exists) {
